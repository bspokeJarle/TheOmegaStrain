...
namespace TheOmegaStrain.Game.World.Objects
{
    public static class AttackShip
    {
        ...
        public static OmegaObject3D CreateAttackShip(ISurface parentSurface)
        {
            ...
            // Visible workshop guides must not enlarge the hull's generated shadow.
            ship.ObjectParts.Find(part => part.PartName == "WeaponStartGuide")!.IsVisible = true;
            ship.ObjectParts.Find(part => part.PartName == "WeaponDirectionGuide")!.IsVisible = true;
            return ship;
        }
